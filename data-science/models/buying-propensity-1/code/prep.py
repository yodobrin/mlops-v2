...
# parser.add_argument("--input-indiviual-entity-data", type=str, dest='raw_dataset_id', help='raw dataset')
...
# using the parsed arguments to build a workspace object
...
indiviual_entity_dataset =  Dataset.Tabular.from_delimited_files(path=(datastore, 'Buying_Propensity_train_Dataset_V5/cursor_INDIVIDUAL_ENTITY_DATA.csv'))
individual_customer_portfolio_dataset =  Dataset.Tabular.from_delimited_files(path=(datastore, 'Buying_Propensity_train_Dataset_V5/cursor_INDIVIDUAL_CUSTOMER_PORTFOLIO.csv'))
policy_base_layer_dataset =  Dataset.Tabular.from_delimited_files(path=(datastore, 'Buying_Propensity_train_Dataset_V5/cursor_POLICY_BASE_LAYER_old.csv'))

INDIVIDUAL_ENTITY_DATA = indiviual_entity_dataset.to_pandas_dataframe()
INDIVIDUAL_CUSTOMER_PORTFOLIO = individual_customer_portfolio_dataset.to_pandas_dataframe()
POLICY_BASE_LAYER = individual_customer_portfolio_dataset.to_pandas_dataframe()
